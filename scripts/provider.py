...
class LiblibProvider(Provider):
    """Use Liblib for Kling image-to-video and temporary local-image upload.

    The legacy submit_image method remains only for old auxiliary scripts. Standard
    Vox keyframes are generated by GPT Image 2 and then uploaded through upload().
    """
    name = "liblib"
...
def get_video_provider(name=None, config=None):
    """Video remains on Liblib/Kling; keep get_provider for older scripts."""
    return get_provider(name or "liblib", config)
